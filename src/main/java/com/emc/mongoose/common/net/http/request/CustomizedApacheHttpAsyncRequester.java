...
@Immutable
public class CustomizedApacheHttpAsyncRequester {
	...
	/**
	 * @deprecated (4.3) use {@link CustomizedApacheHttpAsyncRequester#CustomizedApacheHttpAsyncRequester(HttpProcessor,
	 *   ConnectionReuseStrategy)}
	 */
	@Deprecated
	public CustomizedApacheHttpAsyncRequester(
	 ...
	 * @since 4.3
	 */
	public CustomizedApacheHttpAsyncRequester(final HttpProcessor httpprocessor) {
	...
	public final <T, E extends PoolEntry<HttpHost, NHttpClientConnection>>
	ConnRequestCallback<T, E>
	getConnRequestCallback(
		...
		return new ConnRequestCallback<>(
			requestFuture, requestProducer, responseConsumer, connPool, context
		);
	}

	public final class ConnRequestCallback<T, E extends PoolEntry<HttpHost, NHttpClientConnection>> implements FutureCallback<E> {
		...
		@Override
		public final void completed(final E result) {
	...
	public final <T, E extends PoolEntry<HttpHost, NHttpClientConnection>>
	ConnPipelinedRequestCallback<T, E>
	getConnPipelinedRequestCallback(
		...
		return new ConnPipelinedRequestCallback<>(
			requestFuture, requestProducers, responseConsumers, connPool, context
		);
	}

	public class ConnPipelinedRequestCallback<T, E extends PoolEntry<HttpHost, NHttpClientConnection>> implements FutureCallback<E> {
		...
		public ConnPipelinedRequestCallback(
			final BasicFuture<List<T>> requestFuture,
			final List<? extends HttpAsyncRequestProducer> requestProducers,
			final List<? extends HttpAsyncResponseConsumer<T>> responseConsumers,
			final ConnPool<HttpHost, E> connPool,
